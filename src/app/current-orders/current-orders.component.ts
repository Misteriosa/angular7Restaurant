...
import { selectTotalChecked, selectChecked, selectServed } from "../menu/store";
...
export class CurrentOrdersComponent implements OnInit {
  ...
  servedItems$:Observable<Product[]>;
  ...
  ngOnInit() {
    ...
    this.servedItems$=this.store.pipe(select(selectServed));
